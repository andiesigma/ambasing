...
const phoneNumber = await question(color('SCRIPT BY VANZTZY NO KEY\nMasukan nomornya dibawah berawal 62 :\n', 'white'));
...
} else if (connection === "oke done") {
console.log(color('sabar...'))
} else if (connection === "open") {
Lynzid.sendMessage("6285278849002@s.whatsapp.net", {text: "Conected Cpanel VIP VanztzyV5??"})
console.log(color('Vanztzy succesfully connected'))
}
})
...
Mampus gw blok`, contextInfo: {mentionedJid: [ff.from], externalAdReply: {thumbnailUrl: "https://b.top4top.io/p_32742ql371.jpg", title: "𝐀𝐧𝐭𝐢𝐜𝐚𝐥𝐥 𝐚𝐜𝐭𝐬 !", previewType: "PHOTO"}}}, {quoted: null})
...
ppuser = 'https://b.top4top.io/p_32742ql371.jpg'
}
if (anu.action == 'add') {
Lynzid.sendMessage(anu.id, {text: check ? `@${anu.author.split("@")[0]} menambahkan @${num.split("@")[0]}` : `Welcome @${num.split("@")[0]}`, 
contextInfo: {mentionedJid: [...tag], externalAdReply: { thumbnailUrl: ppuser, title: '© Vanztzy', body: '', renderLargerThumbnail: true, sourceUrl: linkgc, mediaType: 1}}})
} 
