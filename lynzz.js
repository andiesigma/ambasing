/*
SCRIPT INI DIKEMBANGKAN OLEH VANZTZY
...
const qdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: `𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐛𝐲 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`, jpegThumbnail: ""}}}

const qloc = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐛𝐲 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`,jpegThumbnail: ""}}}

const qloc2 = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `𝐏𝐮𝐬𝐡𝐤𝐨𝐧 𝐛𝐲 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`,jpegThumbnail: ""}}}
...
*${sret}🌈𝗠𝗔𝗜𝗡 𝗠𝗘𝗡𝗨 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬🌈${sret}*
* hd 🪩
* aichat on/off 🪩
* sticker🪩
* pinterest 🪩
...
*${sret}💸𝗦𝗧𝗢𝗥𝗘 𝗠𝗘𝗡𝗨💸${sret}*
* done barang,nominal ✅

*${sret}🔖𝗦𝗢𝗨𝗡𝗗 𝗠𝗘𝗡𝗨🔖${sret}*
* tiktokaudio 👙
* ytmp3 👙
  
*${sret}🦄𝗧𝗢𝗢𝗟𝗦 𝗠𝗘𝗡𝗨🦄${sret}*
* toaudio 👅
* tomp3 👅
* tovn 👅
* toptv 👅
...
*${sret}⚡𝗣𝗨𝗦𝗛 𝗞𝗢𝗡𝗧𝗢𝗟 𝗔𝗡𝗧𝗜 𝗞𝗘𝗡𝗢𝗡 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬⚡${sret}*
* pushkontak📡
* pushkontak1📡
* pushkontak2📡
* savekontak📡
...
*${sret}🛸𝗠𝗘𝗡𝗨 𝗚𝗥𝗨𝗣 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬🛸${sret}*
* addmember🎗
* antilink🎗
* antilinkV2🎗
* hidetag🎗
...
*${sret}🚀𝗠𝗘𝗡𝗨 𝗢𝗪𝗡𝗘𝗥 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬🚀${sret}*
* clearsession 🆗🆙
* anticall 🆗🆙
* autotyping 🆗🆙
* autoread 🆗🆙
...
*${sret}💦𝗠𝗘𝗡𝗨 𝗣𝗔𝗡𝗘𝗟 𝗩𝟭 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬💦${sret}*
* adp ⚡
* sadmin ( send akun admin panel )‼️
* listpanel⚠️
* listadmin⚠️
* listmember⚠️
* deladmin⚠️
...
*${sret}💧𝗠𝗘𝗡𝗨 𝗣𝗔𝗡𝗘𝗟 𝗩𝟮 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬💧${sret}*
* adp2 ⚡
* sadmin2 ( send akun admin panel ) ‼️
* listpanel2⚠️
* listadmin2⚠️
* listmember2⚠️
* deladmin2⚠️
...
*${sret}🔋𝗠𝗘𝗡𝗨 𝗥𝗘𝗦𝗘𝗟𝗟𝗘𝗥 𝗦𝗘𝗥𝗩𝗘𝗥 𝟮 𝗕𝗬 𝗩𝗔𝗡𝗭𝗧𝗭𝗬🔋{sret}*
- 1gb 1⃣
- 2gb 2⃣
- 3gb 3⃣
- 4gb 4⃣
...
All Testimoni Lynzz : https://whatsapp.com/channel/0029VarBLTr3wtb714L8cN1o

Saluran Panel Free : https://whatsapp.com/channel/0029VaqXw9S7dmegum5shD2D
...
case 'addown': case 'addowner': {
        ...
        m.reply('Successfully added owner by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜') 
		}
		break;
		...
		fs.writeFileSync(dbowner, JSON.stringify(zippokun)) 
            m.reply('Successfully removed owner by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜') 
			}
break;
...
case 'addprem': case 'addpremium': {
		...
		fs.writeFileSync(dbprem, JSON.stringify(zippokuy)) 
            m.reply('Successfully added premium by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜') 
			}
			break;
...
m.reply("Profile photo changed by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
...
autoTyping = true
m.reply("Successfully turned on autoTyping by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else if (text.toLowerCase() == "off") {
if (!autoTyping) return m.reply("autoTyping is now inactive")
autoTyping = false
m.reply("Successfully turned off autoTyping by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else {
...
autoread = true
m.reply("Successfully turned on autoread by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else if (text.toLowerCase() == "off") {
if (!autoread) return m.reply("Autoread is now inactive")
autoread = false
m.reply("Successfully turned off autoread by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else {
return m.reply(example("on/off\n\nKetik *.statusbot* Untuk Melihat Status Settingan Bot"))
}}
break
...
anticall = true
m.reply("Successfully turned on anticall by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else if (text.toLowerCase() == "off") {
if (!anticall) return m.reply("Anticall is now inactive")
anticall = false
m.reply("Successfully turned off anticall by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else {
return m.reply(example("on/off\n\nKetik *.statusbot* Untuk Melihat Status Settingan Bot"))
}}
break
...
if (!isOwner) return m.reply(msg.owner)
if (!isGroup) return m.reply(msg.group)
await m.reply("Successfully left the group by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜\nMessage : Adios..")
await sleep(3000)
...
if (antilink.includes(m.chat)) return m.reply("Antilink is now active in this group by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
...
await fs.writeFileSync("./all/database/antilink.json", JSON.stringify(antilink))
m.reply("Successfully turned off Antilink in this group by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
} else {
return m.reply(example("on/off"))
}}
break
...
if (!args[0]) return m.reply(example("on/off\n\nKetik *.statusgc* untuk melihat status setting grup ini"))
if (/on/.test(args[0].toLowerCase())) {
if (antilink2.includes(m.chat)) return m.reply("Antilink-v2 is now active in this group by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
...
await fs.writeFileSync("./all/database/antilink2.json", JSON.stringify(antilink2))
m.reply("Antilink-v2 successfully activated in this group by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else if (/off/.test(args[0].toLowerCase())) {
if (!antilink2.includes(m.chat)) return m.reply("Antilink-v2 in this group is not yet active")
let posi = antilink2.indexOf(m.chat)
antilink2.splice(posi, 1)
await fs.writeFileSync("./all/database/antilink2.json", JSON.stringify(antilink2))
m.reply("Successfully turned off Antilink-v2 in this group by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜")
} else {
return m.reply(example("on/off"))
}}
break
...
welcome = true
m.reply("Successfully turned on welcome by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
} else if (text.toLowerCase() == "off") {
if (!welcome) return m.reply("Welcome is now inactive")
welcome = false
m.reply("Successfully turned off welcome by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
} else {
return m.reply(example("on/off\n\nKetik *.statusbot* Untuk Melihat Status Settingan Bot"))
}}
break
...
await fs.unlinkSync(media)
m.reply("Group profile photo changed successfully by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
} else return m.reply(example('dengan mengirim/reply foto'))}
break
...
m.reply(`Group name successfully changed by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲`)
}
break
...
m.reply(`Group description changed successfully by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲`)
}
break
...
m.reply("Successfully changed group settings to allow members to send messages by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
}
break
...
m.reply("Successfully changed group settings to allow only admins to send messages by 𝐯𝐚𝐧𝐳𝐭𝐳𝐲")
}
break
...
await Lynzid.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => Lynzid.sendMessage(m.chat, {text: `yapit ilang 1`, mentions: [`${users}`]}, {quoted: m})).catch((err) => m.reply(err.toString()))
...
if (!isOwner) return m.reply(msg.owner)
if (!isAdmin && !isOwner) return m.reply(msg.admin)
if (!text) return m.reply(example("vanztzy gntg😘"))
var member = await groupMetadata.participants.map(e => e.id)
var teks = ` ${text}\n\n`
...
var teks = text
const halls = await groupMetadata.participants.filter(v => v.id.endsWith('.net')).map(v => v.id)
m.reply(`Being processed by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
for (let mem of halls) {
if (mem !== m.sender) {
contacts.push(mem)
await fs.writeFileSync('./all/database/contacts.json', JSON.stringify(contacts))
...
m.reply(`Processing sending message to ${halls.length} group members by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
for (let mem of halls) {
if (mem !== m.sender) {
contacts.push(mem)
await fs.writeFileSync('./all/database/contacts.json', JSON.stringify(contacts))
...
m.reply(`Processing sending to ${usergc.length} groups by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
...
m.reply(`Successfully sent message to ${total} groups by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
}
break
case "jpmhidetag": {
if (!isOwner) return m.reply(msg.owner)
...
m.reply(`Processing sending text message to ${usergc.length} groups by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
for (let jid of usergc) {
try {
...
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let usergc = groups.map((v) => v.id)
m.reply(`Processing sending polling message to ${usergc.length} groups by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
for (let jid of usergc) {
try {
...
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let usergc = groups.map((v) => v.id)
m.reply(`Processing sending text & photo message to ${usergc.length} groups by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
for (let jid of usergc) {
try {
...
newsletterName: `Testimoni by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`
}}}, {quoted: qchanel})
total += 1
} catch {}
await sleep(global.delayjpm)
...
await Lynzid.sendStimg(m.chat, media, m, {packname: "𝐂𝐫𝐞𝐚𝐭𝐞𝐝 𝐛𝐲 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜 👑"})
await fs.unlinkSync(media)
}
break
...
Lynzid.sendMedia(m.chat, `${i}`, m, {caption: `Successfully downloaded video by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`})
}
} else {
var cap = `*Successfully downloaded video by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`
...
Lynzid.sendMessage(m.chat, {video: {url: `${res.result.url.isHdAvailable == true ? res.result.url.urls[0].hd : res.result.url.urls[0].sd}`}, mimetype: 'video/mp4', caption: `Successfully downloaded video by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`}, {quoted: m})
}).catch(e => m.reply(e.toString()))
}
break
//=======================================//
...
if (isGroup) {
orang = m.sender
await m.reply("𝐀𝐝𝐩 𝐝𝐨𝐧𝐞 𝐜𝐫𝐞𝐚𝐭𝐞 𝐛𝐲 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜 ✅")
} else {
orang = m.chat
}
var teks = `
...
m.reply(`Successfully deleted admin panel by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
}
break
...
if (idadmin == null) return m.reply("ID not found")
m.reply(`Successfully deleted user by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
}
break
case "listadmin2": {
let cek = await fetch(domain2 + "/api/application/users?page=1", {
...
m.reply(`Successfully deleted panel account by 𝐋𝐲𝐧𝐳𝐳𝐎𝐟𝐜`)
}
break
default:
if (budy.startsWith('$')) {
